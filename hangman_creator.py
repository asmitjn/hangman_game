...
class Hangman:
    ...
    def guess_the_letter(self):
        ...
        if(letter in self.guessed_letters):
              print('You have already guessed that letter. Your guesses are: {}'.format(','.join(self.guessed_letters)))
              return
        ...
        if(len(occurences)==0):
            ...
            print('Oops! Your guess was wrong. Attempts remaining are {}'.format(self.attempts_remaining))
        else:
